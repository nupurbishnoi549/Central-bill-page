...
const CustomButton = ({ CustomButton, myClass = "", customClass, customClassBlack, whiteArrow, blackArrow }) => {
    return (
        <div><button className={` ${myClass} font-bold text-white gap-2 cursor-pointer rounded-full hover:scale-90 rounded-tl-none py-3 pl-6 hover:rounded-br hover:rounded-tl-none transition-all duration-700 bg-[#00A8E8] flex items-center text-base`}>{CustomButton}
